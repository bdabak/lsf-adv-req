...
sap.ui.define(
	[
		...
		"com/lesaffre/advance/model/grouper",
	...
	function(
		...
		return BaseController.extend("com.lesaffre.advance.controller.Master", {
			formatter: formatter,
			...
			onInit: function() {
				...
				/*	var oValModel = new JSONModel({
					Code: "",
					Resend: false,
					Phone: "*******93"
				});
				this.setModel(oValModel, "valModel");*/
			...
			onSearch: function(oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [
						new Filter("Advtx", FilterOperator.Contains, sQuery)
					];
				} else {
					this._oListFilterState.aSearch = [];
				}
			...
			onOpenViewSettings: function() {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment(
						"com.lesaffre.advance.view.ViewSettingsDialog",
						this
					);
			...
			onConfirmViewSettingsDialog: function(oEvent) {
				...
				aFilterItems.forEach(function(oItem) {
					switch (oItem.getKey()) {
						case "Filter1":
							aFilters.push(new Filter("Advam", FilterOperator.LE, 1000));
							break;
						case "Filter2":
							aFilters.push(new Filter("Advam", FilterOperator.GT, 1000));
							break;
						default:
							break;
					}
			...
			_onMasterMatched: function() {
				this.getRouter().getTargets().display("welcomePage");
			},
