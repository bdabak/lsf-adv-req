				...
				actions : {
								...
								this.waitFor({
									...
									success : function (oList) {
										...
										if (!aItemsNotInTheList.length) {
											...
											sCurrentId = aEntityData[aEntityData.length - 1].Reqid;
										} else {
											sCurrentId = aItemsNotInTheList[0].Reqid;
										}
										...
										oCurrentItem.bindingPath = "/" + oList.getModel().createKey("AdvanceSet", {
											Reqid : sCurrentId
										});
					...
					iRememberTheListItem : function (oListItem) {
						...
						this.getContext().currentItem = {
							...
							title: oBindingContext.getProperty("Advtx")
						};
					}
				},
				...
				assertions : {
					...
					theListHeaderDisplaysZeroHits : function () {
						return this.waitFor({
							viewName : sViewName,
							id : "page",
							matchers : new PropertyStrictEquals({name : "title", value : "AdvanceSet (0)"}),
							success : function () {
								Opa5.assert.ok(true, "The list header displays 'AdvanceSet (0)'");
							},
					...
					theListShouldBeSortedAscendingOnUnitNumber : function () {
						return this.theListShouldBeSortedAscendingOnField("Advam");
					},

					theListShouldBeSortedAscendingOnName : function () {
						return this.theListShouldBeSortedAscendingOnField("Advtx");
					},
					...
					theListShouldHaveAllEntries : function () {
						...
						// retrieve all AdvanceSet to be able to check for the total amount
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								this.waitFor({
									id : "page",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name : "title", value : "AdvanceSet (" + iExpectedLength + ")"}),
									success : function () {
