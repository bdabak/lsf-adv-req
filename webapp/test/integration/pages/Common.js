sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/lesaffre/advance/app", ".html");
			sHash = sHash || "";
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#AvansTaleplerim-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#AvansTaleplerim-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("com.lesaffre.advance.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/lesaffre/advance/localService/mockserver"], function (mockserver) {
