sap.ui.define([
		...
		opaTest("MasterList Filtering on Advam less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("Advam").
				and.iSelectListItemInViewSettingsDialog("<100 Advcr").
		...
		opaTest("MasterList Filtering on Advam more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 Advcr").
				and.iPressOKInViewSelectionDialog();
